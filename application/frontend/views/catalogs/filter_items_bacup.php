    ...
    <div class="container">
      ...
      <div class="developer-tab-list aaq1">
        ...
        <?}?>
          ...
          <li><a href="#dev-2">Описание</a></li-->
          <?php
			    if ($_SERVER['REQUEST_URI'] == '/nanosoft') {
			        echo '<li><a href="#dev-55">Дистрибутивы</a></li>';
			    }
			    ?>
			    <?php
			    if ($_SERVER['REQUEST_URI'] == '/programmnoe_obespechenie_kompas-3d') {
			        echo '<li><a href="#dev-56">Дистрибутивы</a></li>';
			    }
			    ?>
        </ul>
      ...
      <div class="developer-tab-box">
        ...
        <div class="developer-tab" id="dev-2" style="<? if($count == 1){ echo 'display: block';}else{echo 'display: none';};?>">
          ...
          <? } ?>
        <div class="developer-tab" id="dev-55" style="display: none">
			  <div class="overview-block">
				<div class="overview-left">
				</div>
				<div class="overview-right">
					<p>Платформа nanoCAD25 - Профессиональный инструмент для проектирования и моделирования объектов различной сложности. Используется как графическая платформа для приложений.</p>
					<br>
					<a href="http://mpi-corp.ru/file/NC25.0_7843.exe" download>Скачать дистрибутив</a>
				</div>
			  </div>
        </div>
                <div class="developer-tab" id="dev-56" style="display: none">
			  <div class="overview-block">
				<div class="overview-left">
				</div>
				<div class="overview-right">
					<p>Система тpехмеpного моделиpовaния КОМПАС-3D v23. Система широко используется для проектирования изделий основного и вспомогательного производств в таких отраслях промышленности, как машиностроение (транспортное, сельскохозяйственное, энергетическое, нефтегазовое, химическое и т.д.), приборостроение, авиастроение, судостроение, станкостроение, вагоностроение, металлургия, промышленное и гражданское строительство, товары народного потребления и т. д.</p>
					<br>
					<a href="http://mpi-corp.ru/file/KOMPAS-3D_v23_x64.zip" download>Скачать дистрибутив</a>
				</div>
			  </div>
        </div>
      </div>
